...
> [!NOTE]
> 有AI为什么不用？？？以下内容帮助您使用 DeepSeek R1 快速填写该部分内容
...
##### 使用AI快速生成格式课程
 ...
 以下是我的课程表
 ```
 按住```Ctrl```+```Enter```换行，然后输入你的课程表，接着点击生成即可。然后将输出的内容替换到文件中对应的位置即可
 > [!NOTE]
> 服务器繁忙怎么办，没办法，要么等一会，要么用腾讯元宝的DeepSeek R1咯（摊手）
...
变量后为课程值，您应按照如下格式填写```[早自习]，[第一节课]，[第二节课]，[第三节课]，[第四节课]，[第五节课]，[第六节课]，[第七节课]，[第八节课]，[第九节课]```，若哪个课没有，则用"空"代替，不能什么都不填！
> [!NOTE]
> 有AI为什么不用？？？以下内容帮助您使用 DeepSeek R1 快速填写该部分内容
##### 使用AI快速生成格式课程
 - 打开 DeepSeek 官网
